...
ALTER TABLE ltj_wfs_virka.arvo_kaapakohteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.arvo_liito_orava_elinalueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.arvo_liito_orava_ydinalueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.arvo_metsakohteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.arvo_tarkeat_lepakkoalueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.arvo_tarkeat_matelija_ja_sammakkoelainkohteet
    OWNER TO ltj;
...
CREATE OR REPLACE VIEW ltj_wfs_virka.arvokkaat_geologiset_aluemaiset AS
 SELECT kohde.id,
   ...
   FROM kohde
     ...
     LEFT JOIN arvo ON arvo_kohde.arvoid = arvo.id
     JOIN jakelumetadata ON jakelumetadata.id = 1
  WHERE kohde.luokkatunnus::text = 'GK'::text AND kohde.voimassa = true AND kohde.suojaustasoid <> 1 AND geometrytype(kohde.geometry1) ~~ '%POLYGON'::text
  GROUP BY kohde.id, luokka.nimi, jakelumetadata.id;

ALTER TABLE ltj_wfs_virka.arvokkaat_geologiset_aluemaiset
    OWNER TO ltj;
...
CREATE OR REPLACE VIEW ltj_wfs_virka.arvokkaat_geologiset_viivamaiset AS
 SELECT kohde.id,
   ...
   FROM kohde
     ...
     LEFT JOIN arvo ON arvo_kohde.arvoid = arvo.id
     JOIN jakelumetadata ON jakelumetadata.id = 1
  WHERE kohde.luokkatunnus::text = 'GK'::text AND kohde.voimassa = true AND kohde.suojaustasoid <> 1 AND geometrytype(kohde.geometry1) ~~ '%LINE%'::text
  GROUP BY kohde.id, luokka.nimi, jakelumetadata.id;

ALTER TABLE ltj_wfs_virka.arvokkaat_geologiset_viivamaiset
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.arvokkaat_kasvikohteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.arvokkaat_lintukohteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.ekologiset_yhteydet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.lahokaviosammal_elinymparistot
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.lahokaviosammal_tukialueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.luontoselvityksia
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.luontotyypit_biotooppiaineisto
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.luontotyypit_uhanalaiset
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.metsaverkosto
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.muu_elainhavaintoja
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.muu_perinnemaisemat
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.muut_luontokohteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.rauh_luonnonmuistomerkit
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.rauh_luonnonsuojelualueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.rauh_luonnonsuojeluohjelma
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.rauh_natura_aluemaiset
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.rauh_natura_viivamaiset
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.rauh_suojellut_luontotyypit
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.suojellut_lajikohteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.tarkeat_lintualueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.vesi_kunnostetut_purokohdat
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.vesi_lahteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.vesi_lammet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.vesi_purojen_ja_lampien_valuma_alueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.vesi_purojen_putkitetut_osuudet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.vesi_purot
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.vesi_vedenalainen_roskaantuminen
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_virka.vesi_vesikasvilinjat
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.arvo_kaapakohteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.arvo_liito_orava_elinalueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.arvo_liito_orava_ydinalueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.arvo_metsakohteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.arvo_tarkeat_lepakkoalueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.arvo_tarkeat_matelija_ja_sammakkoelainkohteet
    OWNER TO ltj;
...
CREATE OR REPLACE VIEW ltj_wfs_avoin.arvokkaat_geologiset_aluemaiset AS
 SELECT kohde.id,
   ...
   FROM kohde
     ...
     LEFT JOIN arvo ON arvo_kohde.arvoid = arvo.id
     JOIN jakelumetadata ON jakelumetadata.id = 1
  WHERE kohde.luokkatunnus::text = 'GK'::text AND kohde.voimassa = true AND kohde.suojaustasoid = 3 AND geometrytype(kohde.geometry1) ~~ '%POLYGON'::text
  GROUP BY kohde.id, luokka.nimi, jakelumetadata.id;

ALTER TABLE ltj_wfs_avoin.arvokkaat_geologiset_aluemaiset
    OWNER TO ltj;
...
CREATE OR REPLACE VIEW ltj_wfs_avoin.arvokkaat_geologiset_viivamaiset AS
 SELECT kohde.id,
   ...
   FROM kohde
     ...
     LEFT JOIN arvo ON arvo_kohde.arvoid = arvo.id
     JOIN jakelumetadata ON jakelumetadata.id = 1
  WHERE kohde.luokkatunnus::text = 'GK'::text AND kohde.voimassa = true AND kohde.suojaustasoid = 3 AND geometrytype(kohde.geometry1) ~~ '%LINE%'::text
  GROUP BY kohde.id, luokka.nimi, jakelumetadata.id;

ALTER TABLE ltj_wfs_avoin.arvokkaat_geologiset_viivamaiset
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.arvokkaat_kasvikohteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.arvokkaat_lintukohteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.ekologiset_yhteydet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.lahokaviosammal_elinymparistot
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.lahokaviosammal_tukialueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.luontotyypit_biotooppiaineisto
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.metsaverkosto
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.muu_elainhavaintoja
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.muut_luontokohteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.rauh_luonnonmuistomerkit
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.rauh_luonnonsuojelualueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.rauh_luonnonsuojeluohjelma
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.rauh_natura_aluemaiset
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.rauh_natura_viivamaiset
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.rauh_suojellut_luontotyypit
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.tarkeat_lintualueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.vesi_lahteet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.vesi_lammet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.vesi_purojen_ja_lampien_valuma_alueet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.vesi_purojen_putkitetut_osuudet
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.vesi_purot
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.vesi_vedenalainen_roskaantuminen
    OWNER TO ltj;
...
ALTER TABLE ltj_wfs_avoin.vesi_vesikasvilinjat
    OWNER TO ltj;
...
ALTER TABLE ltj.ltj_lajikohteet
    OWNER TO ltj;
